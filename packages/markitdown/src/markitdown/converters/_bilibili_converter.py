        ...
        *,
        ...
        if prompt is None or prompt.strip() == "":
            prompt = (
                ...
                "Rewrite only the transcript text where needed. Preserve filler words, hesitations, "
                "discourse markers, repeated spoken phrases, and transitional phrases unless they are "
                "clearly duplicated by ASR errors. Do not polish spoken language into written prose. "
                "Remove non-speech ASR event markers such "
                ...
                "boundaries, chunk-boundary split or merge issues, and split overly long transcript blocks "
                "into coherent semantic paragraphs without removing spoken filler or transition words. "
                ...
                "Do not replace uncertain content with a summary, and do not summarize, compress, or omit content. "
                "If a word is uncertain, choose the most "
                "contextually likely correction while preserving the original wording and meaning. Return only the "
