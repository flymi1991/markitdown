        ...
        *,
        ...
        if prompt is None or prompt.strip() == "":
            prompt = (
                ...
                "Remove non-speech ASR event markers, "
                "fix obvious ASR mistakes, punctuation, sentence boundaries, names, technical terms, "
                "broken phrases, and chunk-boundary split or merge issues. Do not invent facts, examples, "
                "timestamps, numbers, or claims. Do not summarize, compress, or omit content. "
